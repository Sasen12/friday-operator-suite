...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "You also have fully local speech-to-text and text-to-speech when configured, plus a configurable LLM that can point at OpenAI or a local Ollama-compatible model. "
        ...
        "You can also adjust laptop display brightness directly with the system tools instead of dragging the Settings slider. "
